...
class CustomCard(override val symbolDrawable: Drawable?, override val figureText: String,
    ...
    private fun drawCenterSymbol(canvas: Canvas, pos: Point, width: Int, height: Int, size: Int) {
        ...
        drawDrawable(canvas, symbolDrawable, makeRect(Point(centerX, centerY), size, size))
    }
